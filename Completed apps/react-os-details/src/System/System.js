...
let getDate=(event)=>{
  console.log(event)
  setPlatform({...Platform,plat:event.view.clientInformation.platform,os:event.view.clientInformation.userAgentData.platform,browser:event.view.clientInformation.userAgentData.brands[2]}) 
}
        ...
        <div className="row">
            <div className="col-md-4">
                <div className="card">
                    ...
                    <div className="card-body bg-info"><ul className='list-group'>
